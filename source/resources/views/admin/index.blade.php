...
<div class="row">
   <div class="col-md-15 col-sm-15 col-xs-12">
      <br>
      <input type='text' id='fecha_inicial' class="form-control bg-date" value="<?php echo date('m');?>-01-<?php echo date("Y");?>" placeholder="Desde" />
   </div>
   <div class="col-md-15 col-sm-15 col-xs-12">
      <br>
      <input type='text' id='fecha_final' class="form-control bg-date" value="<?php echo date('m-d-Y');?>" placeholder="Hasta" />
   </div>
   <div class="col-md-15 col-sm-15 col-xs-12">
      <br>
   ...
   <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="card">
         ...
         <div class="card-body">
            ...
            <i data-feather="alert-circle"></i> No hay resultados para mostrar
            @else
            <span id="sparkline-3" style="width: 100%"></span>
            @endif
         </div>
      </div>
   </div>
