...
<div class="col-md-12">
   <div class="card mb-30">
      <div class="card-header d-flex justify-content-between align-items-center">
        <p>Actualiza las secciones de tu página web aquí</p>
         ...
         <table width="100%" class="table">
            ...
            <tbody>
               ...
               <tr ng-repeat="row in filtered = (list | filter:search | orderBy : predicate :reverse) | startFrom:(currentPage-1)*entryLimit | limitTo:entryLimit">
                  ...
                  <td style="vertical-align: middle; text-transform: uppercase;"> @{{row.title}} </td>
                   <td style="vertical-align: middle; text-transform: uppercase;"> @{{row.page}} </td>
                  <td style="vertical-align: middle;vertical-align: middle; text-align: right;">
                     <a href="{{url('/')}}/sections/@{{row.id}}/edit" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i> Editar</a>
                  </td>
               </tr>
