   ...
   <div class="row">
      <div class="col-lg-6">
         ...
         <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">Listado de widgets</li>
         </ol>
      </div>
   </div>
</div>
   ...
   <div class="col-md-12">
      <div class="card mb-30">
         <div class="card-header d-flex justify-content-between align-items-center">
            <a class="btn btn-pill btn-success" href="{{url('widgets/create')}}"> <i class="fa fa-plus-square-o" aria-hidden="true"></i> Nuevo Widget</a>
               ...
               <tbody id="navsm">
                  ...
                  <tr ng-repeat="row in filtered = (list | filter:search | orderBy : predicate :reverse) | startFrom:(currentPage-1)*entryLimit | limitTo:entryLimit"  id="item_@{{row.id}}">
                     ...
                     <td style="vertical-align: middle; text-align: right;">
                       <a class="btn btn-info btn-sm" style="cursor: move;"><i class="fa fa-arrows"></i> Mover</a>
                        <a href="{{url('/')}}/widgets/@{{row.id}}/edit" title="Editar" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i> Editar</a>
...
app.controller('paginado', function($scope, $http, $window) {
    //Listar Paginas 
    $scope.rows = function() {
        $http.get("{{url('widget_lists')}}").then(function successCallback(response) {
