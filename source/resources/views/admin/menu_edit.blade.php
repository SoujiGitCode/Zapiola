   ...
   <div class="col-md-4 col-sm-4 col-xs-12">
      <div class="card mb-30">
         <div class="card-header d-flex justify-content-between align-items-center">
            <h3>Actualiza los elementos en tu menú aquí</h3>
         </div>
         <div class="card-body">
            <input type="hidden" name="_token" value="{{ csrf_token() }}" id="token">
            <input type="hidden" name="id" value="<?php echo $menu->id;?>" id="id">
            <div class="form-group">
               <label class="active">Url en español<small style="color: #fd2923">*</small></label>
               {!!Form::text('url',$menu->url,['id'=>'url','class'=>'form-control','placeholder'=>'Ingresa la url'])!!}
            </div>
            <div class="form-group">
               <label class="active">Nombre en español<small style="color: #fd2923">*</small></label>
               {!!Form::text('title',$menu->title,['id'=>'title','class'=>'form-control','placeholder'=>'Ingresa el nombre'])!!}
            </div>

            <div class="form-group">
               <label class="active">Url en inglés<small style="color: #fd2923">*</small></label>
               {!!Form::text('url_en',$menu->url_en,['id'=>'url_en','class'=>'form-control','placeholder'=>'Ingresa la url'])!!}
            </div>
            <div class="form-group">
               <label class="active">Nombre en inglés<small style="color: #fd2923">*</small></label>
               {!!Form::text('title_en',$menu->title_en,['id'=>'title_en','class'=>'form-control','placeholder'=>'Ingresa el nombre'])!!}
            </div>
