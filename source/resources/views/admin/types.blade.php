   ...
   <div class="row">
      <div class="col-lg-6">
         ...
         <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">Tipo de propiedad</li>
         </ol>
      </div>
   </div>
</div>
<div class="row" ng-app="myApp" ng-controller="role">
      ...
      <div class="card mb-30">
         ...
         <div class="card-body">
            ...
            <div class="form-group">
               ...
               {!!Form::text('name',null,['id'=>'name','class'=>'form-control','placeholder'=>'Ingresa el nombre en español'])!!}
   ...
   <div class="col-md-8 col-sm-8 col-xs-12">
      <div class="card mb-30">
         <div class="card-header d-flex justify-content-between align-items-center">
            <h3>Listado de tipo de propiedad</h3>
         </div>
         <div class="card-body">
                  ...
                  <tr ng-repeat="row in filtered = (list | filter:search | orderBy : predicate :reverse) | startFrom:(currentPage-1)*entryLimit | limitTo:entryLimit"  id="item_@{{row.id}}">
                     ...
                     <td  class="text-center" style="vertical-align: middle; text-align: right;">
                        <a ng-click="asignarValor(row.id,row.name,row.name_en)"  title="Editar" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i> Editar </a>
                         <a  ng-click="borrar(row.id);" title="Eliminar" class="btn btn-danger btn-sm"><i class="fa fa-times"></i> Eliminar</a>
                     </td>
                  </tr>
...
<script type="text/javascript">
    ...
    app.controller('role', function($scope, $http, $window) {
        $scope.titulo = "Nuevo tipo de propiedad";
        $scope.btn = "Guardar";
        $scope.rows = function() {
        ...
        $scope.borrar = function(id) {
            ...
            function() {
            // Url 
            var route = "{{url('/')}}/properties-types/" + id + "";
            var token = $("#token").val();
            //Enviar Datos
            $.ajax({
                url: route,
        ...
        $scope.asignarValor = function(id, name, name_en) {
            ...
            $("#name").val(name);
             $("#name_en").val(name_en);
            $scope.titulo = "Actualizá tu tipo de propiedad";
            $scope.btn = "Guardar";
        }
    });
