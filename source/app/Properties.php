...
class Properties extends Model {
     ...
     * @var array
     */
    protected $fillable = ['title','url','code','content','image','video','status','position','type_id','video','amenities','bedroom','bathroom','garage','kitchen','address','google_maps','area'];
    /**
     * Set title attribute
     * @param type $value
     */
